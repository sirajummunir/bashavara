                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="contact-block">
                            <form method="post" action="<?php echo base_url(); ?>welcome/owner_report_send">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input class="datepicker picker__input form-control" name="renter_id" type="hidden" value="<?php echo $this->session->userdata('renter_id'); ?>">
                                                <input class="datepicker picker__input form-control" name="owner_id" type="hidden" value="<?php echo $owner; ?>">
