        ...
        <div class="container" style="margin-top:80px">
            ...
            <div class="row">
                <div class="col-md-5 offset-md-1 text-center">
                    <img class="w-75" src="<?php echo base_url(); ?>resource/images/bkash.jpg" alt="Bkash QR Code">
                </div>
                <div class="col-md-5" style="position: relative;
                    ...
                    <ul>
                        <li>Standard</li>
                        <li>Post Limit: 10</li>
                        <li><b>Total Amount: 100</b></li>
                    </ul>
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="contact-block">
                                <form method="post" action="<?php echo base_url(); ?>welcome/payment">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="picker__input form-control" name="owner_id"
                                                        type="hidden"
                                                        value="<?php echo $owner_id=$this->session->userdata('owner_id'); ?>">
                                                    <input class="picker__input form-control" name="tid" type="text"
                                                        value="" data-error="Please enter Transaction ID"
                                                        placeholder="Please enter Transaction ID">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control picker__input" type="text" name="bkash"
                                                        required data-error="Please enter bKash number"
                                                        placeholder="Please enter bKash number*">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control picker__input" type="number"
                                                        name="amount" required data-error="Please enter paid amount"
                                        ...
                                        <div class="col-md-12">
                                            <div class="submit-button text-center">
                                                <input class="btn btn-common" type="submit" value="CONFIRM">
                                            </div>
                                        </div>
                                    </div>
                                </form>
