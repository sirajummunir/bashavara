                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbars-rs-food">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/admin">HOME</a></li>
                            <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(); ?>welcome/pending_post">PENDING POST</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/payments">PAYMENTS</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/renter_report">RENTER REPORT</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>welcome/owner_report">OWNER REPORT</a></li>
                    ...
                    foreach ($pending as $value) {
                        if ($value->pending == 0) {
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-common" style="padding:4px;" href="<?php echo base_url(); ?>welcome/approve/<?php echo $value->ad_id; ?>">Approve</a></td>
                            </tr>
                            <?php
                        }
                    }
