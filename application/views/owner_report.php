                ...
                <table class="table table-striped table-bordered text-center"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Reported Renter</th>
                    ...
                    <tbody>
                        <?php
                            foreach ($owner_report as $index => $value) {
                                ?>
                        <tr>
                            <td scope="row"><?php echo $value->first_name; ?> <?php echo $value->last_name; ?></td>
                            <td><?php echo $value->email; ?></td>
                            <td><?php echo $value->mobile; ?></td>
                            <td><?php echo $owner_report2[$index]->first_name; ?>
                                <?php echo $owner_report2[$index]->last_name; ?></td>
                            <td><?php echo $owner_report2[$index]->email; ?></td>
                            <td><?php echo $owner_report2[$index]->mobile; ?></td>
                            <td><?php echo $value->reason; ?></td>
                            <?php
                                    if ($value->block_account == 1) {
                                        ?>
                            <td><a class="btn btn-common" style="padding:4px;"
                                    href="<?php echo base_url(); ?>welcome/unblock_owner/<?php echo $value->owner_id; ?>"
                                    onclick="return confirm('Are you sure? you want to Unblock this Owner.')">Unblock</a>
                            </td>
                            <?php
                                    } else {
                                        ?>
                            <td><a class="btn btn-danger" style="padding:4px;"
                                    href="<?php echo base_url(); ?>welcome/block_owner/<?php echo $value->owner_id; ?>"
                                    onclick="return confirm('Are you sure? You want to Block this Owner.')">Block</a>
                            </td>
                            <?php
                                    }
                                    ?>
